...
function CetakAllBarangMasuk() {
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: 'cetak-laporan-barang-masuk',
    });
    ...
    const handleDownloadPDF = async () => {
        ...
        pdf.save("cetak-laporan-barang-masuk.pdf");
    };

    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8081/cetakallbarangmasuk');
                ...
                <div className="col-md-12">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p align="center">LAPORAN BARANG MASUK</p>
                            <hr />
                                ...
                                <table className='table table-bordered'>
                                    ...
                                    <tbody>
                                        {data.length > 0 ? data.map((row, key) => (
                                            <tr key={key}>
                                                <td>{key + 1}</td>
                                                <td>{row.id_supplier ? row.id_supplier.nama_supplier : 'N/A'}</td>
