...
function ListSupplier() {
  ...
  const fetchData = async () => {
    await axios.get('http://localhost:8081/suppliers')
  ...
  const handleDelete = async (id) => {
    ...
    axios.delete(`http://localhost:8081/suppliers/${id}`)
      .then(res => {
        Swal.fire({
          icon: "success",
          title: "SUCCESS",
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="d-flex align-items-center">
                      ...
                      <Link className="btn btn-primary btn-round ml-auto" to="/createSupplier">
                        ...
                        <tbody>
                          {data.map((row, key) => (
                            <tr key={key}>
                              ...
                              <td>
                                <Link to={`/editSupplier/${row._id}`} className='btn btn-xs btn-primary'><i className='fa fa-edit'></i> Edit</Link> &nbsp;
